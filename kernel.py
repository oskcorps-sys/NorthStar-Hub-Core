...
# -----------------------------
# PUBLIC API (CALLED BY UI / API)
# -----------------------------
def audit_credit_report(file_path: str) -> Dict[str, Any]:
    """
    Canonical entry point for NorthStar Hub kernel.
